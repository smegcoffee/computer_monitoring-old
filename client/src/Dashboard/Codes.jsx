          ...
          <Grid container spacing={10} justifyContent="center">
            <Grid item xl={4} lg={4} md={6} sm={12} xs={12}>
              <Button className={classes.btn} variant="contained" color="secondary" onClick={onScanFile}
                style={{ marginBottom: "5px", marginTop: "-4px" }}>Upload QR Code to Scan</Button>
              <QrReader
                ref={qrRef}
                delay={300}
                style={{ width: '100%' }}
                ...
                legacyMode
              />
              <h3 className="mt-3">Computer ID:<br />
              </h3>
              {scanResultFile && (
            ...
            <Grid item xl={4} lg={4} md={6} sm={12} xs={12}>
              <h3 style={{ fontSize: "20px", fontWeight: "bold", marginBottom: "8px" }}>Qr Code Scan by Camera</h3>
              <QrReader
                delay={300}
                style={{ width: '100%' }}
